...
<div class="row">
    ...
    <x-dashboard-card-statistics
        title="Estoque"
        bigText="20"
        bigIcon="cube"
        bigIconColor="{{ $estoque <= $estoque_minimo ? 'danger' : 'success' }}"
        smallIcon="cube"
        smallText="Estoque mínimo {{ $estoque_minimo }}"
        />
    ...
    <x-dashboard-card-statistics
        title="Employees"
        bigText="246"
        bigIcon="account-box-multiple"
        bigIconColor="warning"
        />
